...
<div class="sub" style="margin-bottom:6px">1) Onboard: <code>POST /v1/agents/onboard</code> cu master → primești <code>dca_</code>. 2) Intră aici cu <code>dca_</code> + capability.</div>
