...
//!   contributor: CU earned  (durable, origin-agnostic, tier-weighted)
//! ```
...
pub struct CreditFabric {
    ...
    abuse: AbusePolicy,
    valuation: ModelValuationMatrix,
}
...
impl CreditFabric {
    pub fn new(policy: CreditPolicy, abuse: AbusePolicy) -> Self {
        Self {
            ...
            abuse,
            valuation: ModelValuationMatrix::default(),
        }
    }
    ...
    pub fn valuation(&self) -> &ModelValuationMatrix {
        &self.valuation
    }
